...
#### Server B - NIS 서버 , Server B2 - NIS 클라이언트

B,B2 서버에 특정 호스트 이름을 부여<br/>
hostnamectl set-hostname nis.4gl.io (Server B)<br/>
hostanemctl set-hostname nis_client.4gl.io (Server B2)<br/>
